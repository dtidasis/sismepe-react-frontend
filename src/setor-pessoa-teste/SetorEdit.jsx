...
class SetorEdit extends Component {
    ...
    salvar() {
        ...
        let url = `${consts.API_URL}/setor-pessoa-teste`;
    ...
    buscarRegistro(id) {
        const url = `${consts.API_URL}/setor-pessoa-teste/${id}`;
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Setor de Pessoal para Teste COVID-19' small='Inserir' />
                <Content>
                                    ...
                                    <Row>
                                        <Grid cols='12 6 6'>
                                            <div className="form-group">
                                                ...
                                                <input type="text" name='descricao' onChange={(e) => this.onChange(e)} value={this.state.entity.descricao} className="form-control" placeholder="Nome do Setor" />
                                            </div>
