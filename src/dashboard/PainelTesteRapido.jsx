...
class PainelTesteRapido extends Component {
    constructor(props) {
        super(props)
        this.state = {
            casos: {
    ...
    consultarCasos() {
        const url = `${consts.API_URL}/dashboard/teste-rapido`;
        const request = axios.get(url)
            .then(request => {
                let data = { ...this.state.data }
                data.datasets[0].data = [request.data.positivos, request.data.negativos]
        ...
        return (
            ...
            <div className="box box-default">
                <div className="box-header with-border">
                    <h3 className="box-title">Teste Rápido</h3>
...
export default PainelTesteRapido