...
class OperativaList extends Component {
    ...
    excluir(item) {
        let url = `${consts.API_URL}/operativa-pessoa-teste/${item.id}`;
        axios.delete(url)
            .then(request => {
                toastr.success('Mensagem', 'Registro excluído com sucesso!')
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Operativa de Pessoal para Teste COVID-19' small='Consultar' />
                <Content>
