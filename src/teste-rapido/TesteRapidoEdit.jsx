...
class TesteRapidoEdit extends Component {
    ...
    salvar() {
        ...
        let url = `${consts.API_URL}/teste-rapido`;
    ...
    buscarRegistro(id) {
        const url = `${consts.API_URL}/teste-rapido/${id}`;
        const request = axios.get(url)
            .then(request => {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Teste Rápido COVID-19' small='Cadastrar' />
                <Content>
                                ...
                                <form role="form">
                                    ...
                                    <Row>
                                        ...
                                        <Grid cols='12 6 3'>
                                            <div className="form-group">
                                                <label>IgG</label>
                                                <select className="form-control select2" name='igg' onChange={(e) => this.onChange(e)} value={this.state.entity.igg || ''}>
                                                    <option value=''>Selecione</option>
...
export default TesteRapidoEdit